...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u":/icons/icons/black/file-type-pdf.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/icons/black/radioactive.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icons/icons/black/radioactive_filled.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/icons/icons/black/file-database.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/icons/icons/black/database-export.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/icons/icons/black/database-x.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.action_delete_dataset.setIcon(icon5)
        self.action_delete_dataset.setMenuRole(QAction.NoRole)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/icons/icons/black/database-import.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        MainWindow.addToolBar(Qt.LeftToolBarArea, self.tool_export)
        self.tool_project = QToolBar(MainWindow)
        self.tool_project.setObjectName(u"tool_project")
        MainWindow.addToolBar(Qt.LeftToolBarArea, self.tool_project)
        ...
        MainWindow.addToolBar(Qt.LeftToolBarArea, self.tool_seller)
