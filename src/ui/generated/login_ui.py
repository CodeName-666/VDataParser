...
"QGroupBox::title { subcontrol-origin: margin; subcontrol-position: top left; padding: 0 6px; }", None))
        ...
        self.pushButton.setText(QCoreApplication.translate("LoginDialog", u"...", None))
        self.pushButtonLogin.setText(QCoreApplication.translate("LoginDialog", u"Einloggen", None))
    # retranslateUi
